# powershell -ExecutionPolicy Bypass -Command "Invoke-Expression ([System.Text.Encoding]::UTF8.GetString((Invoke-WebRequest -Uri http://localhost:8000/test.ps1 -UseBasicParsing).Content))"
